...
# ****************************************************************
# setting up and running Object Detecttion code
...
#Below provides a huge amount of controll. the 0.70 number is the threshold number, the 0.2 number is the nms number)
        result, objectInfo = getObjects(img,0.70,0.2)
        #print(objectInfo)
        cv2.imshow("Output",img)
        cv2.waitKey(1)


# Publish msg is object has been detected
while True:
    if :
        result = true
        msg = "Object Detected"
